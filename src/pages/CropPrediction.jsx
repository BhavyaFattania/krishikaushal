...
import { handleSubmit } from '../hooks/handleCropPrediction';
        ...
        <>
            ...
            <div className='flex flex-col lg:flex-row m-4'>
                <div className="max-w-xl w-full mx-auto mt-10 p-6 border-2 border-green-600 rounded-lg shadow-md bg-white">
                    ...
                    <form onSubmit={(e) => handleSubmit(e, soilType, climate, previousYield, setLoading, setError, setPrediction)} className="flex flex-col items-center p-4">
